...
const MoonIcon = () => (<svg fill="#ffff00" width="32px" height="32px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="moon-alt-1" class="icon glyph" stroke="#ffff00"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M19,21.21A10,10,0,1,1,19,2.79a10,10,0,0,0,0,18.42Z"></path></g></svg>);
